package com.softwareag.platform.management.productcode.mysql.uibinder;
...
public class UiBindingMySqlUiBinder implements ConfigurationUiBinder {

    private static final String UI_BINDING_XML = "/UpdatedUiBindingForMySql.xml"; //$NON-NLS-1$
