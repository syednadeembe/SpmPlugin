...
public class AdvancedUiBindingDemosJsonUiBinder implements ConfigurationUiBinder {

    private static final String UI_BINDING_XML = "/AdvancedUiBindingDemosJsonBindingsExample.xml"; //$NON-NLS-1$
