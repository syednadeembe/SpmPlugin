...
public class DynamicUiBindingDemosJsonUiBinder implements ConfigurationUiBinder {

    private static final String UI_BINDING_XML = "/DynamicUiBindingDemosJsonBindingsExample.xml"; //$NON-NLS-1$
