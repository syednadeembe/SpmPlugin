package com.softwareag.platform.management.sdk.democases.configuration.uibinder;
...
public class SingletonUiBindingDemosJsonUiBinder implements ConfigurationUiBinder {

    private static final String UI_BINDING_XML = "/SingletonUiBindingDemosJsonBindingsExample.xml"; //$NON-NLS-1$
